...
namespace warp_plus_cloudflare___by_aliilapro__.FRM
{
    ...
    {
        private string proxy_api = "https://api.proxyscrape.com?request=getproxies&proxytype=http&timeout=1000000&country=all&ssl=all&anonymity=all";
        private int _test;
        ...
        private void btngetproxy_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                HttpWebResponse response = (HttpWebResponse)((HttpWebRequest)WebRequest.Create(proxy_api)).GetResponse();
        ...
        private void mtd(object Proxiess)
        {
            ...
            if (start)
            {
                try
                {
                    ...
                    if(_send > 128)
                    {
                        double tb = Double.Parse(this.lblgood.Text) / 1024;
                        this.lblgb.Text = string.Format("{0:N2}", tb) + " TB Successfully added to your account.";
                    }
                    else
        ...
        private void aLIILAPROToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start("https://t.me/aliilapro");
        }

        private void aziToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Process.Start("https://t.me/itsazi1");
        }
    }
}
